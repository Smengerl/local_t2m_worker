...
<!-- Row: FLUX.1 Schnell -->
<div style="display: flex; flex-wrap: nowrap; overflow-x: auto; gap: 24px; margin-bottom: 32px; padding-bottom: 8px;">
 <div style="flex: 0 0 240px; border: 1px solid #ddd; border-radius: 12px; box-shadow: 0 2px 8px #0001; overflow: hidden; background: transparent;">
  <img src="flux_schnell.png" alt="flux_schnell" style="width: 100%; display: block; aspect-ratio: 1/1; object-fit: cover;">
  <div style="text-align: center; padding: 5px 12px; background: #dbeafe; color: #1e40af; font-size: 0.78em; font-weight: 700; letter-spacing: 0.08em;">BASE MODEL</div>
 ...
 <div style="flex: 0 0 240px; border: 1px solid #ddd; border-radius: 12px; box-shadow: 0 2px 8px #0001; overflow: hidden; background: transparent;">
  ...
  <div style="text-align: center; padding: 5px 12px; background: #dcfce7; color: #166534; font-size: 0.78em; font-weight: 700; letter-spacing: 0.08em;">LORA</div>
  <div style="padding: 16px;">
...
<div style="display: flex; flex-wrap: nowrap; overflow-x: auto; gap: 24px; margin-bottom: 32px; padding-bottom: 8px;">
 ...
 <div style="flex: 0 0 240px; border: 2px dashed #ccc; border-radius: 12px; overflow: hidden; background: #fafafa; display: flex; align-items: center; justify-content: center; min-height: 220px;">
  <div style="padding: 24px; text-align: center; color: #aaa;">
   <div style="font-size: 2em; margin-bottom: 8px;">＋</div>
   <div style="font-size: 0.9em;">No LoRA config available yet<br>for this base model.</div>
  </div>
 </div>
</div>
...
<!-- Row: SD 1.5 Default + all LoRAs (inkpunk, pixel art, Comic Diffusion artist styles) -->
<div style="display: flex; flex-wrap: nowrap; overflow-x: auto; gap: 24px; margin-bottom: 32px; padding-bottom: 8px;">
 <div style="flex: 0 0 240px; border: 1px solid #ddd; border-radius: 12px; box-shadow: 0 2px 8px #0001; overflow: hidden; background: transparent;">
...
<!-- Row: SD 2.1 Default + Coloring Book LoRA -->
<div style="display: flex; flex-wrap: nowrap; overflow-x: auto; gap: 24px; margin-bottom: 32px; padding-bottom: 8px;">
 <div style="flex: 0 0 240px; border: 1px solid #ddd; border-radius: 12px; box-shadow: 0 2px 8px #0001; overflow: hidden; background: transparent;">
  <img src="sd21_default.png" alt="sd21_default" style="width: 100%; display: block; aspect-ratio: 1/1; object-fit: cover;">
  <div style="text-align: center; padding: 5px 12px; background: #dbeafe; color: #1e40af; font-size: 0.78em; font-weight: 700; letter-spacing: 0.08em;">BASE MODEL</div>
  <div style="padding: 16px;">
   <div style="font-size: 1em; margin-bottom: 12px;"><strong>Prompt:</strong><br>a solitary lighthouse on a rocky cliff at dusk, dramatic storm clouds, crashing waves, cinematic lighting</div>
   <hr>
   <div style="text-align: center; font-family: monospace; font-size: 0.95em; color: #444;"><code>configs/sd21_default.json</code></div>
  </div>
 </div>
 <div style="flex: 0 0 240px; border: 1px solid #ddd; border-radius: 12px; box-shadow: 0 2px 8px #0001; overflow: hidden; background: transparent;">
